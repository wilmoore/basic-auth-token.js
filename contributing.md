# Contributing to basic-auth-token

Below are a few ways to make contributing to `basic-auth-token` smoother.
...
## Setup
    ...
    git clone https://github.com/wilmoore/basic-auth-token.js.git
    cd basic-auth-token.js
    npm install
    npm run dev
